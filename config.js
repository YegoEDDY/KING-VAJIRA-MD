...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("Yego")
...
global.sudo = process.env.SUDO || '254705677688'
global.devs = '254705677688';
global.website = 'https://github.com/vajirabot1/KING-VAJIRA-MD' // Hello world
global.THUMB_IMAGE = process.env.THUMB_IMAGE || ''
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Yego' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Yego' : process.env.OWNER_NAME,
